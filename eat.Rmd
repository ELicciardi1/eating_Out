...
We see where that the critical p-value was located at the relation between the black and white race. We used show all the see all p-values associated with the combinations and this would indcate the only difference is located with "black" and "white" factors.
